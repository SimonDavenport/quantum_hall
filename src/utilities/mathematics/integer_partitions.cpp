                                    ...
                                    //!     in the partition 
{
	...
	{
	    //  Pad the partition list with zeros
	                                ...
	                                //!     cases of  coloured partitions
{
	...
	if(level<p-1)
	{
		...
		{
			v[level] = i;
			ColouredPartitionIterator(n-i, p, maxPartSize, maxColNbr, v, level+1,
			                          nbrColours, partitionList, colours);
		}
	}
}
	...
	int nSlots)					//!<	Number of parts in the partition
{
	...
	{
	    std::vector<ColouredPartition> uniquePerms;
	    std::vector<char> currColPerm;
        ColouredPartition currPerm(nSlots);
...
//!
//!	Constructor for an object of type ColouredPartition
//!	
...
//!
//!	Destructor for an object of type ColouredPartition
//!	
utilities::ColouredPartition::~ColouredPartition()
{
	delete[] m_list;
...
//!
//!	Copy constructor for an object of type ColouredPartition
//!	
utilities::ColouredPartition::ColouredPartition(
...
//!
//!	Prints out the current value of the coloured integer partition stored
//!	
...
//!
//!	Set a certian integer value in the coloured integer partition array
//!	
...
//!
//!	Set a certain colour value in the coloured integer partition array
//!	
void utilities::ColouredPartition::Set(
	int index,		//!<	Index of value to set
...
#if 0
//!
//!	Iteratively calling this function generates a list of the number of
...
//////////////////////////////////////////////////////////////////////////////////
std::vector<int> utilities::CountIntegerPartitions(
    const int n,	    //!<	Number to be partitioned	
	const int p,		//!<	Maximum number of parts in the partition		
	const int nbrColours)//!<	Number of colours
{
...
#if 0
//!
//!	Iteratively calling this function generates a the number of terms in
