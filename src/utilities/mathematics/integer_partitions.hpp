...
#include "../algorithms/quick_sort.hpp" //  For quick sort algorithm
#include "../general/cout_tools.hpp"    //  For cout manipulation
...
namespace utilities
{
	//  Generate k-r admissible integer partitions
    ...
    //  Generate coloured integer partitions with various optional constraints
	...
	void UnqiueColourPerms(int* partition,
		std::vector<std::vector<char> >& colourList,int nSlots);
 
    ////////////////////////////////////////////////////////////////////////////////
    //!	\brief 	Data struct to specify data used for sorting coloured partitions.
	...
	////////////////////////////////////////////////////////////////////////////////
	//!	\brief A class to define an object which is simply a list of PartitionData
	...
	////////////////////////////////////////////////////////////////////////////////
	//	Functions to count integer partitions
    #if 0
	void CountIterator(int n,const int p, int* v,
				int level,const int nbrColours,std::vector<int>& nbrTerms);
