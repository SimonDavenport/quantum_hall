...
namespace occupationBasis
{
    ...
    void AssignEnergies(std::vector<std::vector<std::bitset<_MAX_NUMBER_> > >& occupationsList, 
        double* energyLevels, double* spectrum, const double normalization, const int nbrStates,
        const int nbrLevels);
    void AssignSquaredEnergies(std::vector<std::vector<std::bitset<_MAX_NUMBER_> > >& occupationsList,
        double* energyLevels, double* spectrum, const double normalization, const int nbrStates,
        const int nbrLevels);
