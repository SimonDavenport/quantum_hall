...
//!
//! Acts as a place holder to describe complex mpf variables
//!
...
{
    //!
    //! A class template to implement the Kahan summation algorithm for 
    ...
    class HpWrap
    {
	    ...
	    //!
	    //!	Multiplication by some other type
	    //!
	    ...
	    //!
	    //!	Define a function to multiply by long int
	    //!
	    ...
	    //!
	    //!	Overload function MulBy for double* type
	    //!
	    ...
	    //!
	    //!	Set the internal variable to some external value
	    ...
	    //!
	    //!	Return the value of the internal variable as a dcmplx type.
	    //!	Redeclared in specializations
	    //!
    ...
    //!
    //!	Specialization of the cpWrap template class to double variables
    //!	
    template <int P> class HpWrap<double, P>
    {
	    ...
	    //!
	    //!	Return a pointer to the internal variable
	    //!
    ...
    //!
    //!	Specialization of the cpWrap template class to mpc_t variables
    //!	
    ...
    //!
    //!	Specialization of the cpWrap template class to mpfr_t variables
    //!	
    ...
    //!
    //!	Specialization of the cpWrap template class to mpf_t variables
    //!	
