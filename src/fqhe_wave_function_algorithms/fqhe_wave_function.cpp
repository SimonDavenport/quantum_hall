...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
    ...
    ////////////////////////////////////////////////////////////////////////////////
    //! \brief Set the Sphere and/or disc radius based on the current value of the flux
    //!
    ////////////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////////////////
    //!	\brief	Generates a string containing a file name composed of relevant
    ...
    void FQHE::WaveFunctionData::GenerateFileName()
    {
	    ...
	    if(this->statistics == _BOSONS_)    name<<"bosons_";
	    else				           	    name<<"fermions_";
	
	    //////////////////////////////////////////////////////////////////////////////
	    #if _ENABLE_SPHERE_GEOMETRY_
	
	    if(this->geometry == _SPHERE_)	name<<"sphere";
	    ...
	    if(this->geometry == _DISC_)		name<<"disc";
	    ...
	    if(this->geometry == _TORUS_) 	name<<"torus"<<"_"<<this->torusState<<"_"<<this->Lx<<"_"<<this->Ly;
	...
	////////////////////////////////////////////////////////////////////////////////
//!	\brief	Prints out a full summary of current wave function data
//!
////////////////////////////////////////////////////////////////////////////////
...
void FQHE::WaveFunctionData::CheckAndPrint() const
{
	...
	utilities::cout.MainOutput()<<utilities::cout.HyphenLine()<<std::endl<<utilities::cout.HyphenLine()<<std::endl<<std::endl;
	    ...
	    utilities::cout.MainOutput()<<"\n\tFilling Factor\t\t\t"<<this->fillNumerator<<"/"<<this->fillDenominator;
	    ...
	    utilities::cout.MainOutput()<<"\n\tStatistics\t\t\t"<<((this->statistics == _BOSONS_) ? ("Bosons") : ("Fermions"))<<std::endl<<std::endl;
